...
import br.com.messiasjunior.converter.exception.InvalidTimeFormatException;
...
class ConverterServiceImplTest {
	...
	void convertFirstHalfWithAdditionalTime() {
	...
	void throwExceptionIfTimeFormatIsInvalid() {
		assertThrows(InvalidTimeFormatException.class, () -> service.convertMatchTime("90:00"));
		assertThrows(InvalidTimeFormatException.class, () -> service.convertMatchTime("FOO"));
	}
